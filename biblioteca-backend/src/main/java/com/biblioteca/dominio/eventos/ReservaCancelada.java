...
public final class ReservaCancelada implements IDomainEvent {
    ...
    public ReservaCancelada(String reservaId, String usuarioId, String materialId) {
    ...
    @Override public String eventType()   { return "ReservaCancelada"; }
