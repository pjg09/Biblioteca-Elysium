...
public final class PrestamoRenovado implements IDomainEvent {
    ...
    private final LocalDateTime nuevaFechaDevolucion;
    private final int renovacionesUsadas;
    ...
    public LocalDateTime getNuevaFechaDevolucion() { return nuevaFechaDevolucion; }
