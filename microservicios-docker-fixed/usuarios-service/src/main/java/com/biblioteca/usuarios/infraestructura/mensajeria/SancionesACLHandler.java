...
/**
 * Anti-Corruption Layer (ACL) para el bounded context de sanciones (BC9).
 *
 * Traduce los eventos externos PeticionBloqueoUsuario / PeticionDesbloqueoUsuario
 * (vocabulario de BC9) en comandos del dominio interno de usuarios
 * (bloquearPorDeuda / desbloquear).
 *
 * Un único listener distingue el tipo de evento por routing key.
 */
@Service
public class SancionesACLHandler {
    ...
    private void handlePeticionBloqueo(String payload) throws Exception {
        ...
        // Publicar evento UsuarioBloqueadoPorDeuda hacia otros bounded contexts
