package com.biblioteca.circulacion.infraestructura.api;
...
public class CirculacionController {
    ...
    /**
     * POST /prestamos — Registrar un nuevo prestamo.
     */
    @PostMapping
    ...
    /**
     * POST /prestamos/{id}/devolucion — Registrar la devolucion de un prestamo.
     */
    ...
    /**
     * POST /prestamos/{id}/renovacion — Renovar un prestamo activo.
     */
    ...
    /**
     * GET /prestamos/{id} — Obtener un prestamo por su id.
     */
    @GetMapping("/{id}")
    ...
    /**
     * GET /prestamos?usuarioId={id} — Listar prestamos de un usuario.
     */
    @GetMapping
