package com.biblioteca.multas.aplicacion.dto;
...
public class DeudaPendienteDTO {
    ...
    public DeudaPendienteDTO(String usuarioId, double totalDeuda, int multasPendientes) {
        this.usuarioId = usuarioId;
        this.totalDeuda = totalDeuda;
        this.multasPendientes = multasPendientes;
        this.tieneDeuda = totalDeuda > 0;
    }
